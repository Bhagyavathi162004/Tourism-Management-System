...
int food()
 {
    vector<string> cities = {"Bengaluru", "Mumbai", "Delhi", "Chennai", "Kolkata", "Hyderabad", "Pune", "Jaipur", "Ahmedabad", "Lucknow", "Coimbatore", "Bhopal", "Darjeeling", "Shimla", "Goa", "Agra", "Varanasi", "Udaipur", "Amritsar", "Mysore", "Thiruvananthapuram", "Vishakhapatnam"};
